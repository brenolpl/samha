...
public class PublicController {
    ...
    @PostMapping("relatorio/gerar-relatorio-professor")
    ...
    @PostMapping("relatorio/obter-aulas-turma")
    ...
    @PostMapping("relatorio/gerar-relatorio-turma")
    ...
    @PostMapping("relatorio/obter-professores-relatorio")
    ...
    @PostMapping("relatorio/gerar-relatorio-disciplina")
